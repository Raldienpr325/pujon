...
<div id="wrapper">
    ...
    <div class="sidebar-brand-text mx-1" style="text-align: left;">LAPORAN TENAGA HARIAN LEPAS</div>
        ...
        <li class="nav-item {{ Nav::isRoute('pageharian') }}">
            <a class="nav-link" href="{{ route('pageharian') }}">
                <i class="fas fa-fw fa-calendar-day"></i>
                <span>{{ __('Laporan Harian') }}</span></a>
        </li>

        <li class="nav-item {{ Nav::isRoute('listlaporan') }}">
            <a class="nav-link" href="{{ route('listlaporan') }}">
                <i class="fas fa-fw fa-calendar"></i>
                <span>List Laporan</span>
            </a>
        </li>

        <li class="nav-item {{ Nav::isRoute('tahunan') }}">
            <a class="nav-link" href="{{ route('tahunan') }}">
        ...
        <!-- Nav Item - Profile -->
        <li class="nav-item {{ Nav::isRoute('Atasan') }}">
